...
> **AS-BUILT RECORD (frozen 2026-07-04).** This is the v0.4 build+analysis spec the
> project was constructed from. The build is complete: every §15 "Pending" item shipped,
> and later work (schema_v1 normalization, the data-v1 release, mfmt/pre-commit, the
> VistA Compass extension) is deliberately absent — see `docs/README.md` for the live map.
> The one live part, the §11.3–§11.6 extraction/PIKS contract, now lives at
> [`../reference/model-extraction-contract.md`](../reference/model-extraction-contract.md)
> (amended by [`../reference/schema-v1-normalization-spec.md`](../reference/schema-v1-normalization-spec.md)).
